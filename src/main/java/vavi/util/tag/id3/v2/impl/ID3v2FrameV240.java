...
/**
 * This class contains one ID3v2 frame. (Version 2.4.0)
 * <p>
...
public class ID3v2FrameV240 implements ID3v2Frame, Serializable {
     ...
     */
    public ID3v2FrameV240(String key, byte[] content, boolean tag_alter_preservation, boolean file_alter_preservation, boolean read_only, byte compression_type, byte encryption_id, byte group) throws ID3v2Exception {
...
logger.warning("id: " + id + ": " + StringUtil.getDump(head, 4) + ", length is larger than rest: " + length + "/" + dis.available());
    ...
    // status
    /** */
    private final static byte FLAG_TAG_ALTER_PRESERVATION = (byte) (1 << 6);
    /** */
    private final static byte FLAG_FILE_ALTER_PRESERVATION = (byte) (1 << 5);
    /** */
    private final static byte FLAG_READ_ONLY = (byte) (1 << 4);

    // format
    /** */
    private final static byte FLAG_COMPRESSION = (byte) (1 << 3);
    /** */
    private final static byte FLAG_ENCRYPTION = (byte) (1 << 2);
    /** */
    private final static byte FLAG_GROUPING = (byte) (1 << 6);
    /** */
    private final static byte FLAG_UNSYNCH = (byte) (1 << 1);
    /** */
    private final static byte FLAG_REALSIZE = (byte) (1 << 0);
...
e.printStackTrace(System.err);
            throw new ID3v2Exception("decompression", e);
        }
    }
    ...
    static {
        try {
            ids.load(ID3v2FrameV240.class.getResourceAsStream("/vavi/util/tag/id3/v2/impl/v230.properties"));
        } catch (IOException e) {
e.printStackTrace(System.err);
        }
    }
