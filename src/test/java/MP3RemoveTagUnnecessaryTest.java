...
/**
 * MP3RemoveTagUnnecessaryTest. (mp3 remove unnecessary tags test)
 *
 * @author <a href="mailto:umjammer@gmail.com">Naohide Sano</a> (nsano)
 * @version 0.00 051225 nsano initial version <br>
 */
public class MP3RemoveTagUnnecessaryTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MP3RemoveTagUnnecessaryTest app = new MP3RemoveTagUnnecessaryTest();
